    ...
    <div class="container pt-5">
        <div class="row g-5">
            <div class="col-lg-3 col-md-6">
                ...
                <p class="mb-2">
                    <i class="bi bi-geo-alt text-primary me-2"></i>Nguyễn Văn Thoại, Đà Nẵng
                </p>
                <p class="mb-2">
                    <i class="bi bi-envelope-open text-primary me-2"></i>Gmail: perfumeshoptv@gmail.com
                </p>
                <p class="mb-0">
                    <i class="bi bi-telephone text-primary me-2"></i>SĐT: 08962 10648
                </p>
            </div>
            <div class="col-lg-3 col-md-6">
                <h5 class="text-uppercase border-start border-5 border-primary ps-3 mb-4">
            ...
            <div class="col-lg-3 col-md-6">
                ...
                <div class="d-flex flex-column justify-content-start">
                    ...
                    <p class="bi bi-arrow-right text-center text-primary me-2">0896210648</p>
                </div>
            </div>
